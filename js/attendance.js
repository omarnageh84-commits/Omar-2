    ...
    <div class="card" style="margin:0; padding:0; overflow:hidden; border-radius:18px; border:1px solid #e5e7eb">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; background:#fff">
        <div style="border-right:1px solid #f3f4f6">
          <div style="display:flex; justify-content:space-between; align-items:center; padding:10px 12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">الساعة</span><input data-k="totalSalary" class="inline-edit" type="number" value="${totalSalary}" style="width:70px; padding:8px 10px; border:1.5px solid #e5e7eb; border-radius:10px; font-size:14px; font-weight:800; text-align:center"></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:10px 12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">كم يوم</span><input data-k="workDays" class="inline-edit" type="number" value="${workDaysSet}" style="width:70px; padding:8px 10px; border:1.5px solid #e5e7eb; border-radius:10px; font-size:14px; font-weight:800; text-align:center"></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">سعر الساعة</span><span style="font-size:15px; font-weight:900; color:#10b981">${hourPrice.toFixed(2)}</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">عدد الساعات</span><span style="font-size:14px; font-weight:800">${totalHours.toFixed(1)}</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:14px 12px; background:#ecfdf5; direction:rtl"><span style="font-size:13px; font-weight:800; color:#065f46">الصافي</span><span style="font-size:16px; font-weight:900; color:#059669">${net.toFixed(0)}</span></div>
        </div>
        <div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:10px 12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">المطلوب</span><input data-k="required" class="inline-edit" type="number" value="${required}" style="width:70px; padding:8px 10px; border:1.5px solid #e5e7eb; border-radius:10px; font-size:14px; font-weight:800; text-align:center"></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:13px; font-weight:700">المطلوب يوميا</span><span style="font-size:15px; font-weight:800; color:#f59e0b">${requiredDailyHours.toFixed(2)}</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:10px 12px; border-bottom:1px solid #f9fafb; direction:rtl"><span style="font-size:12px; font-weight:700">ديون<br>للصيدلية</span><input data-k="pharmacyDebt" class="inline-edit" type="number" value="${pharmacyDebt}" style="width:70px; padding:8px 10px; border:1.5px solid #e5e7eb; border-radius:10px; font-size:14px; font-weight:800; text-align:center"></div>
          <div style="height:44px; border-bottom:1px solid #f9fafb"></div>
          <div style="display:flex; justify-content:space-between; align-items:center; padding:14px 12px; background:#fff1f2; direction:rtl"><span style="font-size:13px; font-weight:800">المتبقي</span><span style="font-size:16px; font-weight:900; color:#e11d48">${fmtNum(remaining)}</span></div>
        </div>
      </div>
    </div>
